...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container py-3">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 py-1">
                <div class="card">
                    <asp:HyperLink runat="server" NavigateUrl="" CssClass="card-body">
                        <asp:Image runat="server" ImageUrl="../ASSETS/IMG/blog.svg" CssClass="w-100" />
                    </asp:HyperLink>
                    <asp:HyperLink runat="server" NavigateUrl="" CssClass="card-footer text-center" Font-Bold="True">
                        Blog
                    </asp:HyperLink>
                </div>
            </div>
